...
void testTableLoader() {
    ...
    if (col_xy.size() > 0)
        husky::LOG_I << "xy999" << col_xy[999][0] << std::endl;
    ...
    if (col_feat.size() > 0)
        husky::LOG_I << "feat" << col_feat[9].coeffRef(5) << std::endl;
    if (col_feat.size() > 0)
        husky::LOG_I << "feat" << col_feat[9].size() << std::endl;
    ...
    if (col_itemname.size() > 0)
        husky::LOG_I << col_itemname[0] << " " << col_price[0] << std::endl;
    //--------------------------------------------------------------------------------------
